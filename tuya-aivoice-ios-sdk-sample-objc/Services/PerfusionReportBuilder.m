//
//  PerfusionReportBuilder.m
//  AIVoiceDemo
//

#import "PerfusionReportBuilder.h"

@implementation PerfusionReportInput
@end

@implementation PerfusionReportBuilder
...
+ (NSString *)htmlReportWithInput:(PerfusionReportInput *)input
    ...
    if (lineResults.count > 0) {
        ...
        for (PerfusionWERLineResult *line in lineResults) {
        ...
        for (PerfusionWERLineResult *line in lineResults) {
            PerfusionWERResult *r = line.result;
